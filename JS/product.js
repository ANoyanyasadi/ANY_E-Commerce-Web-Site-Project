...
export const fetchProducts = async () => {
  try {
    ...
    //! Hata varsa  hatayı console'a yazdır
    console.error(error);
    return [];
  }
};

//! Ürünleri render eden Fonksyon

export const renderProducts = (products, addToCartCallBack) => {

  //! Html'de ürünlerin listeleneceği kısmı seç
  const productList = document.querySelector("#productList");

  //! Ürünleri ekrana bas
  //! Html'deki Products List'in içeriğini dön
